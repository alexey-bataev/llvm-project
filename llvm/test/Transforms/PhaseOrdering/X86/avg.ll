...
; AVX2-NEXT:    [[TMP1:%.*]] = trunc i64 [[A_COERCE1:%.*]] to i16
; AVX2-NEXT:    [[TMP2:%.*]] = trunc i64 [[B_COERCE0:%.*]] to i16
; AVX2-NEXT:    [[TMP3:%.*]] = trunc i64 [[B_COERCE1:%.*]] to i16
...
; AVX2-NEXT:    [[TMP4:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE0]], i64 0
; AVX2-NEXT:    [[TMP5:%.*]] = shufflevector <8 x i64> [[TMP4]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX2-NEXT:    [[TMP6:%.*]] = lshr <8 x i64> [[TMP5]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX2-NEXT:    [[TMP7:%.*]] = insertelement <8 x i64> poison, i64 [[A_COERCE0]], i64 0
; AVX2-NEXT:    [[TMP8:%.*]] = insertelement <8 x i64> [[TMP7]], i64 [[ADD5]], i64 1
; AVX2-NEXT:    [[TMP9:%.*]] = and <8 x i64> [[TMP6]], <i64 -1, i64 255, i64 255, i64 255, i64 255, i64 255, i64 0, i64 0>
; AVX2-NEXT:    [[TMP10:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE1]], i64 0
; AVX2-NEXT:    [[TMP11:%.*]] = shufflevector <8 x i64> [[TMP10]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX2-NEXT:    [[TMP12:%.*]] = lshr <8 x i64> [[TMP11]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX2-NEXT:    [[TMP13:%.*]] = insertelement <2 x i16> poison, i16 [[TMP0]], i64 0
; AVX2-NEXT:    [[TMP14:%.*]] = insertelement <2 x i16> [[TMP13]], i16 [[TMP1]], i64 1
; AVX2-NEXT:    [[TMP15:%.*]] = lshr <2 x i16> [[TMP14]], splat (i16 8)
; AVX2-NEXT:    [[TMP16:%.*]] = insertelement <2 x i16> poison, i16 [[TMP2]], i64 0
; AVX2-NEXT:    [[TMP17:%.*]] = insertelement <2 x i16> [[TMP16]], i16 [[TMP3]], i64 1
; AVX2-NEXT:    [[TMP18:%.*]] = lshr <2 x i16> [[TMP17]], splat (i16 8)
; AVX2-NEXT:    [[TMP19:%.*]] = add nuw nsw <2 x i16> [[TMP15]], splat (i16 1)
...
; AVX2-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i64> [[TMP8]], <8 x i64> [[TMP24]], <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 8>
...
; AVX2-NEXT:    [[TMP29:%.*]] = add nuw nsw <8 x i64> [[TMP28]], [[TMP9]]
...
; AVX2-NEXT:    [[TMP38:%.*]] = and <8 x i64> [[TMP12]], <i64 -1, i64 255, i64 255, i64 255, i64 255, i64 255, i64 0, i64 0>
...
; AVX512-NEXT:    [[TMP1:%.*]] = trunc i64 [[A_COERCE1:%.*]] to i16
; AVX512-NEXT:    [[TMP2:%.*]] = trunc i64 [[B_COERCE0:%.*]] to i16
; AVX512-NEXT:    [[TMP3:%.*]] = trunc i64 [[B_COERCE1:%.*]] to i16
...
; AVX512-NEXT:    [[TMP4:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE0]], i64 0
; AVX512-NEXT:    [[TMP5:%.*]] = shufflevector <8 x i64> [[TMP4]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX512-NEXT:    [[TMP6:%.*]] = lshr <8 x i64> [[TMP5]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX512-NEXT:    [[TMP7:%.*]] = insertelement <8 x i64> poison, i64 [[A_COERCE0]], i64 0
; AVX512-NEXT:    [[TMP8:%.*]] = insertelement <8 x i64> [[TMP7]], i64 [[ADD5]], i64 1
; AVX512-NEXT:    [[TMP9:%.*]] = and <8 x i64> [[TMP6]], <i64 -1, i64 255, i64 255, i64 255, i64 255, i64 255, i64 0, i64 0>
; AVX512-NEXT:    [[TMP10:%.*]] = insertelement <8 x i64> <i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 poison, i64 -1, i64 -1>, i64 [[B_COERCE1]], i64 0
; AVX512-NEXT:    [[TMP11:%.*]] = shufflevector <8 x i64> [[TMP10]], <8 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 6, i32 7>
; AVX512-NEXT:    [[TMP12:%.*]] = lshr <8 x i64> [[TMP11]], <i64 56, i64 48, i64 40, i64 32, i64 24, i64 16, i64 0, i64 0>
; AVX512-NEXT:    [[TMP13:%.*]] = insertelement <2 x i16> poison, i16 [[TMP0]], i64 0
; AVX512-NEXT:    [[TMP14:%.*]] = insertelement <2 x i16> [[TMP13]], i16 [[TMP1]], i64 1
; AVX512-NEXT:    [[TMP15:%.*]] = lshr <2 x i16> [[TMP14]], splat (i16 8)
; AVX512-NEXT:    [[TMP16:%.*]] = insertelement <2 x i16> poison, i16 [[TMP2]], i64 0
; AVX512-NEXT:    [[TMP17:%.*]] = insertelement <2 x i16> [[TMP16]], i16 [[TMP3]], i64 1
; AVX512-NEXT:    [[TMP18:%.*]] = lshr <2 x i16> [[TMP17]], splat (i16 8)
; AVX512-NEXT:    [[TMP19:%.*]] = add nuw nsw <2 x i16> [[TMP15]], splat (i16 1)
...
; AVX512-NEXT:    [[TMP25:%.*]] = shufflevector <8 x i64> [[TMP8]], <8 x i64> [[TMP24]], <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 8>
...
; AVX512-NEXT:    [[TMP29:%.*]] = add nuw nsw <8 x i64> [[TMP28]], [[TMP9]]
...
; AVX512-NEXT:    [[TMP38:%.*]] = and <8 x i64> [[TMP12]], <i64 -1, i64 255, i64 255, i64 255, i64 255, i64 255, i64 0, i64 0>
