...
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <8 x i32> [[TMP5]], <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <4 x i32> [[TMP22]], i64 0
...
; CHECK-NEXT:    [[TMP20:%.*]] = extractelement <4 x i32> [[TMP23]], i64 3
