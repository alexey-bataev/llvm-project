...
; CHECK-NEXT:    [[TMP4:%.*]] = insertelement <2 x i64> poison, i64 [[TMP7]], i64 0
; CHECK-NEXT:    [[TMP5:%.*]] = shufflevector <2 x i64> [[TMP4]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP6:%.*]] = shl <2 x i64> [[TMP5]], <i64 1, i64 2>
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <2 x i64> [[TMP6]], i64 0
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr i8, ptr [[D]], i64 [[TMP10]]
; CHECK-NEXT:    [[TMP12:%.*]] = extractelement <2 x i64> [[TMP6]], i64 1
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr i8, ptr [[D]], i64 [[TMP12]]
; CHECK-NEXT:    [[TMP21:%.*]] = insertelement <2 x i64> poison, i64 [[TMP3]], i64 0
; CHECK-NEXT:    [[TMP22:%.*]] = shufflevector <2 x i64> [[TMP21]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP23:%.*]] = mul <2 x i64> [[TMP22]], <i64 6, i64 3>
; CHECK-NEXT:    [[TMP14:%.*]] = extractelement <2 x i64> [[TMP23]], i64 0
; CHECK-NEXT:    [[SCEVGEP42:%.*]] = getelementptr i8, ptr [[D]], i64 [[TMP14]]
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <2 x i64> [[TMP23]], i64 1
; CHECK-NEXT:    [[TMP16:%.*]] = getelementptr i8, ptr [[D]], i64 [[TMP15]]
; CHECK-NEXT:    [[TMP24:%.*]] = udiv i64 1, [[V]]
; CHECK-NEXT:    [[TMP25:%.*]] = insertelement <2 x i64> poison, i64 [[TMP24]], i64 0
; CHECK-NEXT:    [[TMP26:%.*]] = shufflevector <2 x i64> [[TMP25]], <2 x i64> poison, <2 x i32> zeroinitializer
; CHECK-NEXT:    [[TMP27:%.*]] = mul <2 x i64> [[TMP26]], <i64 5, i64 4>
; CHECK-NEXT:    [[TMP17:%.*]] = extractelement <2 x i64> [[TMP27]], i64 0
; CHECK-NEXT:    [[TMP18:%.*]] = getelementptr i8, ptr [[D]], i64 [[TMP17]]
; CHECK-NEXT:    [[TMP19:%.*]] = extractelement <2 x i64> [[TMP27]], i64 1
