...
; CHECK-NEXT:    [[TMP22:%.*]] = fptoui <4 x float> [[TMP16]] to <4 x i32>
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <4 x i32> [[TMP22]], i64 3
; CHECK-NEXT:    [[TMP27:%.*]] = icmp ne i32 [[TMP26]], 0
; CHECK-NEXT:    [[NARROW:%.*]] = select i1 [[TMP21]], i1 [[TMP27]], i1 false
; CHECK-NEXT:    [[CONV_I_I1743_2:%.*]] = extractelement <4 x i32> [[TMP22]], i64 2
...
; CHECK-NEXT:    [[TMP28:%.*]] = shufflevector <4 x i1> [[TMP20]], <4 x i1> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP29:%.*]] = shufflevector <4 x i32> [[TMP22]], <4 x i32> poison, <2 x i32> <i32 0, i32 1>
; CHECK-NEXT:    [[TMP33:%.*]] = select <2 x i1> [[TMP28]], <2 x i32> [[TMP29]], <2 x i32> zeroinitializer
; CHECK-NEXT:    [[NARROW2:%.*]] = extractelement <2 x i32> [[TMP33]], i64 1
; CHECK-NEXT:    [[RV3:%.*]] = or i32 [[TMP25]], [[NARROW2]]
; CHECK-NEXT:    [[NARROW4:%.*]] = extractelement <2 x i32> [[TMP33]], i64 0
