...
; CHECK-NEXT:    [[TMP18:%.*]] = extractelement <4 x float> [[TMP16]], i64 3
; CHECK-NEXT:    [[CONV_I_I1743_3:%.*]] = fptoui float [[TMP18]] to i32
; CHECK-NEXT:    [[TMP27:%.*]] = icmp ne i32 [[CONV_I_I1743_3]], 0
...
; CHECK-NEXT:    [[NARROW:%.*]] = select i1 [[TMP21]], i1 [[TMP27]], i1 false
; CHECK-NEXT:    [[TMP26:%.*]] = extractelement <4 x float> [[TMP16]], i64 2
; CHECK-NEXT:    [[CONV_I_I1743_2:%.*]] = fptoui float [[TMP26]] to i32
...
; CHECK-NEXT:    [[TMP33:%.*]] = extractelement <4 x float> [[TMP16]], i64 1
; CHECK-NEXT:    [[CONV_I_I1743_1:%.*]] = fptoui float [[TMP33]] to i32
; CHECK-NEXT:    [[TMP28:%.*]] = extractelement <4 x i1> [[TMP20]], i64 1
; CHECK-NEXT:    [[NARROW2:%.*]] = select i1 [[TMP28]], i32 [[CONV_I_I1743_1]], i32 0
; CHECK-NEXT:    [[RV3:%.*]] = or i32 [[TMP25]], [[NARROW2]]
; CHECK-NEXT:    [[TMP29:%.*]] = extractelement <4 x float> [[TMP16]], i64 0
; CHECK-NEXT:    [[CONV_I_I1743:%.*]] = fptoui float [[TMP29]] to i32
; CHECK-NEXT:    [[TMP34:%.*]] = extractelement <4 x i1> [[TMP20]], i64 0
; CHECK-NEXT:    [[NARROW4:%.*]] = select i1 [[TMP34]], i32 [[CONV_I_I1743]], i32 0
