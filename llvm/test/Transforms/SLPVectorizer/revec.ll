...
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <32 x i1> [[TMP6]], <32 x i1> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
; CHECK-NEXT:    [[TMP17:%.*]] = and <16 x i1> [[TMP22]], [[TMP16]]
; CHECK-NEXT:    [[TMP15:%.*]] = shufflevector <16 x i1> [[TMP17]], <16 x i1> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <16 x i1> [[TMP17]], <16 x i1> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
; CHECK-NEXT:    [[RDX_OP:%.*]] = or <4 x i1> [[TMP15]], [[TMP12]]
; CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <16 x i1> [[TMP17]], <16 x i1> poison, <4 x i32> <i32 8, i32 9, i32 10, i32 11>
; CHECK-NEXT:    [[RDX_OP1:%.*]] = or <4 x i1> [[RDX_OP]], [[TMP13]]
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <16 x i1> [[TMP17]], <16 x i1> poison, <4 x i32> <i32 12, i32 13, i32 14, i32 15>
